...
- 複数商品の一括追加（「牛乳と卵」など）
- 音声認識後の自動追加設定
- 音声入力ボタンの動作モード設定（切り替え/長押し）
- 音声コマンドによる商品の削除・購入済みマーク
...
- **ベーシックプラン**: 広告非表示、リスト30個、タブ10個まで（月額240円/年額2,200円）
- **プレミアムプラン**: 無制限利用、テーマ・フォントカスタマイズ（月額480円/年額4,800円）
- **ファミリープラン**: プレミアム機能 + 家族共有（月額720円/年額6,000円）
