...
class SettingsTheme {
  ...
  static List<Map<String, dynamic>> getAvailableFonts() {
    return FontSettings.getAvailableFonts();
  }
  ...
  /// デフォルトのカスタムカラーを取得
  static Map<String, Color> getDefaultCustomColors() {
    return {
  ...
  /// デフォルトの詳細カラーを取得
  static Map<String, Color> getDefaultDetailedColors() {
    final customColors = getDefaultCustomColors();
    return {
...
class SettingsState extends ChangeNotifier {
  ...
  Map<String, Color> _customColors = SettingsTheme.getDefaultCustomColors();
  Map<String, Color> _detailedColors = SettingsTheme.getDefaultDetailedColors();
  ...
  void initializeDetailedColors() {
    _detailedColors = SettingsTheme.getDefaultDetailedColors();
  }
